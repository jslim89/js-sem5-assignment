 ...
 * @version $Id: JRViewerPanel.java 3035 2009-08-27 12:05:03Z teodord $
 */
public class JRViewerPanel extends JPanel implements JRHyperlinkListener, JRViewerListener
{
	...
	protected void paintPage(Graphics2D grx)
	{
		...
		try
		{
			...
			exporter.setParameter(JRExporterParameter.PAGE_INDEX, new Integer(viewerContext.getPageIndex()));
